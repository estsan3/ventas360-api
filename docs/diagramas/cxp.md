...
Fuente: `app/modulos/cxp/` · Flujo principal: `ContratoCxp.registrar_debe` (invocado por compras al confirmar factura directa o facturar remito; confirmar remito no toca CxP).
...
sequenceDiagram
    ...
    Cliente->>Router: GET /cxp/proveedores/{proveedor_id}
