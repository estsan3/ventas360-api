...
Artículos duplicados en el conteo → `ReglaDeNegocioViolada`. Deltas en 0 cuentan como `sin_cambio`.
...
| PUT | `/stock/depositos/{id}` | `actualizar_deposito` |
| PATCH | `/stock/depositos/{id}/desactivar` | `desactivar_deposito` |
