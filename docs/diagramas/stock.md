...
`ContratoStock`: `obtener_saldo`, `saldo_total_articulo`, `deposito_default_id` (primer depósito activo), `establecer_cantidad`, `egresar`, `ingresar`. Usado por **ventas**, **compras** y **productos**.
