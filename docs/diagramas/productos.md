...
SKU único. Si `stock > 0`, sincroniza el saldo del depósito default vía contrato (misma TX). Si no hay depósito default, el alta igual confirma y el stock plano queda en el catálogo.
