...
Prefijo HTTP: `/api/v1`. Verificado contra routers/services: **2026-09-23**.
...
Chequeo rápido: las rutas `PATCH .../desactivar` van con sufijo (`/{id}/desactivar`), no sobre el recurso raíz.
