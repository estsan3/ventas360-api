...
Valida imputaciones contra comprobantes cobrables (remito/factura), registra haber en CxC e impacta tesorería según medio.
...
sequenceDiagram
    ...
    Service->>BO: validar_medio y validar_recibo
