...
`ContratoCxc`: `registrar_debe`, `registrar_haber`, `saldo_cliente`, `existe_referencia`. Usado por **ventas** y **cobranzas**. El haber operativo lo escribe **cobranzas** (`referencia_tipo` `recibo`).
