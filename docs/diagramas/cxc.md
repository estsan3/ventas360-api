...
`ContratoCxc`: `registrar_debe`, `registrar_haber`, `saldo_cliente`, `existe_referencia`. El debe lo escribe **ventas**; el haber **cobranzas**. `existe_referencia` evita duplicar CxC al facturar un remito ya imputado.
