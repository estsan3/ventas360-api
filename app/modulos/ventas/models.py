...
class Pedido(ConTenant, Base):
    ...
    cae_vencimiento: Mapped[date | None] = mapped_column(Date, nullable=True, default=None)
    letra: Mapped[str | None] = mapped_column(String(1), nullable=True, default=None)
    cbte_tipo: Mapped[int | None] = mapped_column(Integer, nullable=True, default=None)
    punto_venta: Mapped[int | None] = mapped_column(Integer, nullable=True, default=None)
    cbte_nro: Mapped[int | None] = mapped_column(Integer, nullable=True, default=None)
    doc_tipo: Mapped[int | None] = mapped_column(Integer, nullable=True, default=None)
    doc_nro: Mapped[str | None] = mapped_column(String(13), nullable=True, default=None)
    qr_url: Mapped[str | None] = mapped_column(String(500), nullable=True, default=None)
